...
export default function Notification() {
    ...
    <SafeAreaView style={[style.area,{backgroundColor:theme.bg,paddingTop:30}]}>
     ...
     <View style={{marginTop:30,borderColor:Colors.bord,borderWidth:1,paddingHorizontal:20,paddingVertical:30,borderRadius:15}}>
            <Text style={{fontSize:12,color:Colors.disable,fontWeight:'600',fontFamily:'PlusJakartaSans-Regular'}}>Messages Notifications</Text>
            <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginTop:20}}>
                <Text style={[style.txt1,{color:theme.txt,}]}>Payment Reminder</Text>
                <Switch
            ...
            <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                <Text style={[style.txt1,{color:theme.txt,}]}>Schedule Reminder</Text>
                 <Switch
                  trackColor={{false: Colors.disable, true: Colors.primary}}
            ...
            <View style={[style.divider1,{backgroundColor:Colors.bord}]}></View>
            <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                <Text style={[style.txt1,{color:theme.txt}]}>Call</Text>
                <Switch
                  trackColor={{false: Colors.disable, true: Colors.primary}}
